...
DIR = "*****/hipfracture/python/PNG_30Day_Mortality_HipFractures/30day_mortality_learning_from_imaging/chest/production/all"

if new_model:
    experiment_name = '30day_mortality_learning_from_chest_and_structured_v1000_20_0_structured_dataset_' + version_number+'_'+str(int(time()))
else:
...
classifier = 'Xception - [16-8-4]'

experiment_notes = 'learning from chest, imagenet weights and structured simultaneously'
...
if new_model:
    base_model = xception.Xception(input_shape=(image_dim, image_dim, 3),
                                          weights=weights,
                                          include_top=False,
                                          pooling='avg')
