...
new_experiment_name = '30day_mortality_learning_from_hip_14_0_0_'+str(int(time()))

# select modality -> chest or hip
modality = "hip"

# select pre-trained convolutional model
classifier = resnet.ResNet152
...
experiment_notes = 'full training, imagenet weights, FC arch --> '+\
    str(dense_0_neurons)+'-'+ str(dense_1_neurons)+', class imbalance not handled'
